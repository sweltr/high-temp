...
```{r}
set_to_plot <- c("its18_ps_work", "its18_ps_filt", "its18_ps_perfect", "its18_ps_pime")
tax_group <- c("Ascomycota", "Basidiomycota", 
               "Glomeromycota")
...
```{r, code_folding=TRUE}
its18_alpha_ds <- c("its18_ps_work","its18_ps_work_Ascomycota", "its18_ps_work_Basidiomycota", "its18_ps_work_Glomeromycota")
...
objects()
its18_ps_work_Ascomycota_hill
its18_ps_work_Basidiomycota_hill
its18_ps_work_Glomeromycota_hill
```
...
```{r}
its18_ps_work_me$sample_table$GROUP <- stringr::str_c(
  its18_ps_work_me$sample_table$TREAT, "", its18_ps_work_me$sample_table$TEMP)
temp_order <- c("C0", "W3", "W8")
its18_ps_work_me$sample_table$GROUP %<>% factor(., levels = c("C0", "W3", "W8"))
its18_ps_work_me$cal_alphadiv(PD = FALSE)
t8 <- trans_alpha$new(dataset = its18_ps_work_me, group = "GROUP")
t8$cal_diff(method = "anova")
t8$alpha_data$GROUP %<>% factor(., levels = temp_order)

t8$plot_alpha(add_letter = T, measure = "Observed", use_boxplot = TRUE)
t8$plot_alpha(add_letter = T, measure = "Chao1", use_boxplot = TRUE)
t8$plot_alpha(add_letter = T, measure = "ACE", use_boxplot = TRUE)
t8$plot_alpha(add_letter = T, measure = "Shannon", use_boxplot = TRUE)
t8$plot_alpha(add_letter = T, measure = "Simpson", use_boxplot = TRUE)
t8$plot_alpha(add_letter = T, measure = "InvSimpson", use_boxplot = TRUE)
t8$plot_alpha(add_letter = T, measure = "Fisher", use_boxplot = TRUE)
```

```{r}
its18_ps_work_Ascomycota_me$sample_table$GROUP <- stringr::str_c(
  its18_ps_work_Ascomycota_me$sample_table$TREAT, "", its18_ps_work_Ascomycota_me$sample_table$TEMP)
temp_order <- c("C0", "W3", "W8")
its18_ps_work_Ascomycota_me$sample_table$GROUP %<>% factor(., levels = c("C0", "W3", "W8"))
its18_ps_work_Ascomycota_me$cal_alphadiv(PD = FALSE)
t10 <- trans_alpha$new(dataset = its18_ps_work_Ascomycota_me, group = "GROUP")
t10$cal_diff(method = "anova")
t10$alpha_data

t10$plot_alpha(add_letter = T, measure = "Observed", use_boxplot = TRUE)
t10$plot_alpha(add_letter = T, measure = "Chao1", use_boxplot = TRUE)
t10$plot_alpha(add_letter = T, measure = "ACE", use_boxplot = TRUE)
t10$plot_alpha(add_letter = T, measure = "Shannon", use_boxplot = TRUE)
t10$plot_alpha(add_letter = T, measure = "Simpson", use_boxplot = TRUE)
t10$plot_alpha(add_letter = T, measure = "InvSimpson", use_boxplot = TRUE)
t10$plot_alpha(add_letter = T, measure = "Fisher", use_boxplot = TRUE)
```

```{r}

its18_ps_work_Basidiomycota_me$sample_table$GROUP <- stringr::str_c(
  its18_ps_work_Basidiomycota_me$sample_table$TREAT, "", its18_ps_work_Basidiomycota_me$sample_table$TEMP)
temp_order <- c("C0", "W3", "W8")
its18_ps_work_Basidiomycota_me$sample_table$GROUP %<>% factor(., levels = c("C0", "W3", "W8"))
its18_ps_work_Basidiomycota_me$cal_alphadiv(PD = FALSE)

t13 <- trans_alpha$new(dataset = its18_ps_work_Basidiomycota_me, group = "GROUP")
t13$cal_diff(method = "anova")
t13$alpha_data

t13$plot_alpha(add_letter = T, measure = "Observed", use_boxplot = TRUE)
t13$plot_alpha(add_letter = T, measure = "Chao1", use_boxplot = TRUE)
t13$plot_alpha(add_letter = T, measure = "ACE", use_boxplot = TRUE)
t13$plot_alpha(add_letter = T, measure = "Shannon", use_boxplot = TRUE)
t13$plot_alpha(add_letter = T, measure = "Simpson", use_boxplot = TRUE)
t13$plot_alpha(add_letter = T, measure = "InvSimpson", use_boxplot = TRUE)
t13$plot_alpha(add_letter = T, measure = "ACE", use_boxplot = TRUE)
t13$plot_alpha(add_letter = T, measure = "Fisher", use_boxplot = TRUE)
```

```{r}
its18_ps_work_Glomeromycota_me$sample_table$GROUP <- stringr::str_c(
  its18_ps_work_Glomeromycota_me$sample_table$TREAT, "", its18_ps_work_Glomeromycota_me$sample_table$TEMP)
temp_order <- c("C0", "W3", "W8")
its18_ps_work_Glomeromycota_me$sample_table$GROUP %<>% factor(., levels = c("C0", "W3", "W8"))

its18_ps_work_Glomeromycota_me$cal_alphadiv(PD = FALSE)
t22 <- trans_alpha$new(dataset = its18_ps_work_Glomeromycota_me, group = "GROUP")
t22$cal_diff(method = "anova")
#t22$alpha_data

t22$plot_alpha(add_letter = T, measure = "Observed", use_boxplot = TRUE)
t22$plot_alpha(add_letter = T, measure = "Chao1", use_boxplot = TRUE)
t22$plot_alpha(add_letter = T, measure = "ACE", use_boxplot = TRUE)
t22$plot_alpha(add_letter = T, measure = "Shannon", use_boxplot = TRUE)
t22$plot_alpha(add_letter = T, measure = "Simpson", use_boxplot = TRUE)
t22$plot_alpha(add_letter = T, measure = "InvSimpson", use_boxplot = TRUE)
t22$plot_alpha(add_letter = T, measure = "Fisher", use_boxplot = TRUE)
t22$plot_alpha(add_letter = T, measure = "Coverage", use_boxplot = TRUE)
```
