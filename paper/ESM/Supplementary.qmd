...
caption_tab("tab_norm_test_ssu", "Summary of 16S rRNA significant tests.")
caption_tab("tab_alpha_div_its", "Hill numbers for ITS samples.")
caption_tab("tab_norm_test_its", "Summary of ITS significant tests.")
...
caption_tab("tab_beta_sig", "Summary of beta diversity significant tests.")
...
caption_fig("alpha_div_plots_ssu", "Alpha diversity of 16S rRNA communities. Significant differences denoted by asterisks (* p $\\le$ 0.05, ** p $\\le$ 0.01, *** p $\\le$ 0.001, **** p $\\le$ 0.0001).")

caption_fig("alpha_div_plots_its", "Alpha diversity of ITS communities. Significant differences denoted by asterisks (* p $\\le$ 0.05, ** p $\\le$ 0.01, *** p $\\le$ 0.001, **** p $\\le$ 0.0001). ")
...
supp_table <- read_delim("TABLES/sample_details.txt", delim = "\t")
knitr::kable(supp_table, col.names = gsub("[_]", " ", names(supp_table)), align = c("l","c","c","c","c"), 
  ...
  pack_rows(NULL, 1, 3, latex_gap_space = "-0.3em") %>%
  pack_rows(NULL, 4, 6, latex_gap_space = "-0.3em") %>%
  pack_rows(NULL, 7, 9, latex_gap_space = "-0.3em") %>%
  pack_rows(NULL, 10, 12, latex_gap_space = "-0.3em") %>%
  pack_rows(NULL, 13, 15, latex_gap_space = "-0.3em")
