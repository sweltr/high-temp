...
```{r initial_load_its18, include=FALSE, eval=FALSE}
## Initial Load for  ANALYSIS #1
#remove(list = ls())
#set.seed(119)
...
<iframe src="https://widgets.figshare.com/articles/16828063/embed?show_title=1" width="568" height="251" allowfullscreen frameborder="0"></iframe>
...
The source code for this page can be accessed on GitHub by [clicking this link](https://github.com/sweltr/high-temp/blob/master/beta.Rmd). 
