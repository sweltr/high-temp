...
tmp_data$edaphic$TREAT_T <- as.character(tmp_data$edaphic$TREAT_T)

tmp_comm <- data.frame(t(ssu18_select_mc_norm_split_no_ac$data_loaded))

tmp_env <- data.frame(ssu18_select_mc_norm_split_no_ac$edaphic)
#tmp_env$edaphic$TREAT_T <- as.character(tmp_env$edaphic$TREAT_T)
edpahic_adonis2 <- adonis2(tmp_comm ~ TREAT_T* AST, data = tmp_data$edaphic)
