...
datatable(ssu18_sig_summary, width = "100%", rownames = FALSE, caption = htmltools::tags$caption(
            style = 'caption-side: bottom; text-align: left;',
            'Table: ', htmltools::em('Results of envfit & bioenv test for the 16S rRNA data set.')),
          elementId = "95p2uxf1n8lpjbc2t0r9",
    ...
    DT::formatRound(columns = c(3:ncol(ssu18_sig_summary)),
                    digits = 3) %>%
    DT::formatStyle(columns = colnames(ssu18_sig_summary),
                    fontSize = '80%')
```
...
```{r, echo=FALSE, layout="l-body", eval=TRUE}
datatable(its18_sig_summary, width = "100%", rownames = FALSE, caption = htmltools::tags$caption(
            style = 'caption-side: bottom; text-align: left;',
            'Table: ', htmltools::em('Results of envfit & bioenv test for the ITS data set.')),
          elementId = "w114ycn9zt4kx4ip8165",
          extensions = 'Buttons', options = list(
            scrollX = TRUE,
            dom = 'Blftip',
            buttons = c('copy', 'csv', 'excel'),
    ...
    DT::formatRound(columns = c(3:ncol(its18_sig_summary)),
                    digits = 3) %>%
    DT::formatStyle(columns = colnames(its18_sig_summary),
                    fontSize = '80%')
remove(list = ls())
```
...
# Remaining edaphic: AG_Q10, BG_Q10, BP_Q10, CE_Q10, P_Q10, N_Q10, S_Q10, XY_Q10, LP_Q10, PX_Q10, CUEcn, CUEcp, Tmin, SI
...
A) Environmental and edaphic properties: TEB, DON, Na, Al, Ca.
B) Microbial functional responses: micN, micNP, enzCN, enzCP, BP_ase, CE_ase, LP_ase, N_ase, P_ase.
C) Temperature adaptation properties: NUE, PUE, P_Q10, Tmin.
...
soil_funct_remove <- c("micN", "micNP", "enzCN", "enzCP", "BP_ase", 
                       "CE_ase", "LP_ase", "N_ase", "P_ase")
temp_adapt_remove <- c("NUE", "PUE", "P_Q10", "Tmin")
```
...
temp_adapt_bioenv_ind_mantel <- list(LP_Q10 = LP_Q10_bioenv_mantel_test,
                                     N_Q10 = N_Q10_bioenv_mantel_test,
                                     XY_Q10 = XY_Q10_bioenv_mantel_test, 
                                     SI = SI_bioenv_mantel_test)
rm(list = ls(pattern = "_bioenv_mantel_test"))
```
...
* Starting properties: AG_Q10, BG_Q10, BP_Q10, CE_Q10, P_Q10, N_Q10, S_Q10, XY_Q10, LP_Q10, PX_Q10, CUEcn, CUEcp, NUE, PUE, Tmin, SI
* Autocorrelated removed: NUE, PUE, P_Q10, Tmin                                                                        
* Remove for capscale: S_Q10

```{r, echo=FALSE}
# All temp_adapt: AG_Q10, BG_Q10, BP_Q10, CE_Q10, P_Q10, N_Q10, S_Q10, XY_Q10, LP_Q10, PX_Q10, CUEcn, CUEcp, NUE, PUE, Tmin, SI
# REMOVED edaphic: NUE, PUE, P_Q10, Tmin                                                                        
# Remaining edaphic: AG_Q10, BG_Q10, BP_Q10, CE_Q10, N_Q10, S_Q10, XY_Q10, LP_Q10, PX_Q10, CUEcn, CUEcp, SI
# only works with 11
# Removed:  S_Q10
```
